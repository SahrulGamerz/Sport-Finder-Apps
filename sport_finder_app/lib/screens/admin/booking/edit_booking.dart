...
class BookingEditWidget extends StatefulWidget {
  ...
  final String id;
  BookingEditWidget({Key? key, required this.dataMap, required this.id}) : super(key: key);
              ...
              return new FutureBuilder(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      ...
                      documentSnapshot.data() as Map<String, dynamic>;
                      now = date;
                      textController2.text = TimeOfDay.fromDateTime(time1).format(context);
                      textController3.text = TimeOfDay.fromDateTime(time2).format(context);
                      return Column(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Align(
                                      ...
                                      child: Padding(
                                        padding:
                                        EdgeInsetsDirectional.fromSTEB(20, 2, 200, 2),
                                            ...
                                            if (!_btnOnce) {
                                              ...
                                              setState(() async {
                                                ...
                                                await games
                                                    .update({
                                                  "gameDetails": {
                                                    "court_name": gameDetails['court_name'],
                                                    "date": time1,
                                                    "to": time2,
                                                    "gameType": gameDetails['gameType'],
                                                    "slots": gameDetails['slots'],
                                                  },
                                                })
                                                    .then(
                                                        (value) =>
          ...
          builder: (context, snapshot) {
            if (snapshot.hasData) {
              ...
              try{
                ...
                print(e);
                return new Center(child: Text("Booking has been deleted by administrator!"));
              }
            } else if (snapshot.hasError) {
              return new Text("An error occurred, Please try again!");
            }
